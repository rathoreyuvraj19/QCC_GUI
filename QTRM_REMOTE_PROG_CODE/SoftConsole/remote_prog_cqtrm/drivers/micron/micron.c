...
/*Change 3: old DEVICE_ID_READ      0x90*/

//#define DEVICE_ID_READ      0x90
//#define DEVICE_ID_READ      0x9E
#define DEVICE_ID_READ      0x9F // Yuvraj
...
/*change*/
static void wait_ready_flag( void );
//void wait_ready_erase( void );
/*******************************************************************************
 *
 */
...
#else
    MSS_SPI_set_slave_select( &g_mss_spi0, MSS_SPI_SLAVE_0);
    //change : MSS_SPI_transfer_block( &g_mss_spi0, cmd_buffer, 4, read_buffer, sizeof(read_buffer) );
    MSS_SPI_transfer_block( &g_mss_spi0, cmd_buffer, 1, read_buffer, sizeof(read_buffer) );
    MSS_SPI_clear_slave_select( &g_mss_spi0, MSS_SPI_SLAVE_0 );

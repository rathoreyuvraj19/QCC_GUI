...
from core.command_style import SUCCESS_COLOR as _OK_COLOR
from core.command_style import FAILURE_COLOR as _FAIL_COLOR
from core.command_style import indicator_style as _indicator_style_base
from core.command_style import send_button_style
from core.packet import PRT_COUNT_INFINITE
...
class TimingTab(QWidget):
    ...
    def _on_prt_infinite_toggled(self, checked: bool):
        ...
        self.prt_count_spin.setEnabled(not checked)
